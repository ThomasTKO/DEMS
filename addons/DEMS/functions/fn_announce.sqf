...
/*
	...
	[_messageType,_messageTitle,_messageBody,[_image,_barColor,_titleColor,_bodyColor]] call FrSB_fnc_announce;
	...
	*/
    ...
    case "popUp": 
				{ 
					...
					[_messageTitle,_messageBody,_msgTxtColor,_msgBgColor] spawn Haz_fnc_createNotification;
				};
