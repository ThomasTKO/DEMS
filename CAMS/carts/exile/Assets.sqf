...
[	
	...
	*/
	...
	[
		"CAMS_Exile_Toy_Bikes",1,true,
		[
			"Exile_Bike_OldBike","Exile_Bike_MountainBike"
		]
	],
	[
		"CAMS_Toy_Bikes",0,false,
		[
			"CAMS_Exile_Toy_Bikes"
		]
	],
	[
		"CAMS_Exile_Toy_Quads",1,true,
		[
	...
	[
		"CAMS_Toy_Quads",0,false,
		[
			"CAMS_Exile_Toy_Quads"
		]
	],	
	[
		"CAMS_Exile_Toy_Karts",1,true,
		[
			"Exile_Car_Kart_BluKing","Exile_Car_Kart_RedStone","Exile_Car_Kart_Vrana","Exile_Car_Kart_Green",
	...
	[
		...
		[
			"CAMS_Exile_Toy_Bikes", "CAMS_Exile_Toy_Quads", "CAMS_Exile_Toy_Karts"
		]
	],
	// BOATS
	[
	...
	[
		"CAMS_Exile_H20_RubberDucks",1,true,
		[
	...
	[
		"CAMS_Exile_H20_RHIB",1,true,
		[
			"Exile_Boat_RHIB"
		]
	],
	[
		"CAMS_Exile_H20_SDVs",1,true,
		[
			"Exile_Boat_SDV_CSAT","Exile_Boat_SDV_Digital","Exile_Boat_SDV_Grey"
		]
	],
	[
		"CAMS_Exile_H20_Jetski",1,true,
		[
